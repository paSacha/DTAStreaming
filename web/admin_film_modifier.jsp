...
<html>
    ...
    <body>
		...
		<div class="field_group">
                    ...
                    <input type="text" name="champ_titre" required="required" value="${monFilm.title}">
		</div>
		<br>
		<div class="field_group">	
                    <label for="champ_resume"> Résumé</label>
                    <input type="text" name="champ_resume" value="${monFilm.resume}">
		</div>
		<br>
		<div class="field_group">
		...
		<div class="field_group">
                    ...
                    <input type="text" name="champ_duree" value="${monFilm.duree}">
		</div>
                <br>
		<div class="field_group">
                    <label for="champ_annee"> Année</label>
                    <input type="text" name="champ_annee" value="${monFilm.annee}">
		</div>
		<br>
		<div class="field_group">
